package com.example.tugaslanjutan;
...
public class MainActivity extends AppCompatActivity {
        ...
        simpanCatatan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isiCatatan.getText().toString().isEmpty()) {
                    Toast.makeText(getApplicationContext(), "Konten catatan tidak boleh kosong",
                            Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (masukkanCatatan) {
                    Toast.makeText(getApplicationContext(), "Catatan berhasil disimpan",
                            Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void dialogDaftarCatatan () {
        ...
        AdapterDaftarCatatan adapterDaftarCatatan = new AdapterDaftarCatatan(setterGetterData,
